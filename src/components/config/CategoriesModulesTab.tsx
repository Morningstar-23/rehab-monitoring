...
export const CategoriesModulesTab: React.FC<CategoriesModulesTabProps> = ({ categories, modules }) => {
  ...
  // Toggle Collapse Single Category
  ...
  const toggleExpandCollapseAll = () => {
    if (collapsedCategories.size === categories.length) {
      ...
      setCollapsedCategories(new Set(categories.map(c => c.id))); // Collapse all
    }
  };

  // Filter Categories & Modules based on search and selected pill
    ...
    <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-2 bg-slate-50 border border-slate-200 text-slate-700 rounded-xl text-xs font-semibold hover:bg-slate-100 transition-all"
            >
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 bg-emerald-600 text-white rounded-xl text-xs font-semibold hover:bg-emerald-700 transition-all shadow-sm"
            >
      ...
      <div className="space-y-4">
        {filteredCategories.map(cat => {
          ...
          // If searching and this category has no matching modules, hide it
          ...
          return (
            ...
            >
              ...
              <div
                ...
                className="p-4 flex items-center justify-between cursor-pointer select-none bg-white hover:bg-slate-50/75 transition-colors border-b border-slate-200/60"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-sm text-slate-900 leading-snug">{cat.name}</h3>
              ...
              {/* Modules Grid (Collapsed/Expanded) */}
              {!isCollapsed && (
